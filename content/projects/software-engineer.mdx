...
description: As a software engineering intern at Bask you will work directly with the CEO, CTO, and the rest of the team to build and design the software infrastructure that will serve as the backbone of telehealth.
date: "2023-05-03"
...
Now Accepting Applicants for our paid Summer '23 CO-OP
...
As a software engineering intern at Bask you will work directly with the CEO, CTO, and the rest of the team to build and design the software infrastructure that will serve as the backbone of telehealth.
...
It is important to be familiar with these frameworks, with Javascript and API architecture being a must.
...
- You also have strong backend skills (Postgres, GraphQL, mySQL).
